...
const services = [
  ...
  },
  {
    id: "interiors",
    icon: Layers,
    badge: "Bespoke Interiors & Fitouts",
    ...
    features: [
      ...
      "Designer Gyproc False Ceilings with Layered Ambient COB Spotlights & Magnetic Track Light Raceways",
      "Custom Veneer & Louvered TV Media Wall Unit with Concealed Cable Guttering",
      "Kalinga Quartz & Italian Marble Countertops with Under-Mount 304 Stainless Steel Sinks",
      "Acoustic Wall Panelling, Custom Upholstered Bed Headboards & Vastu Space Orientation",
    ],
    materials: "Hettich / Hafele Soft-Close Hardware • CenturyPly BWP 710 Marine Ply • Asian Paints Royale • Saint-Gobain Gyproc • Kalinga Quartz",
  },
];
