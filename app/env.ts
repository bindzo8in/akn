...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_ADDRESS_STREET: z.string().min(1),
    NEXT_PUBLIC_ADDRESS_FULL: z.string().min(1),

    // Social
    NEXT_PUBLIC_INSTAGRAM_HANDLE: z.string().min(1),
    NEXT_PUBLIC_INSTAGRAM_URL: z.string().url(),
    NEXT_PUBLIC_YOUTUBE_HANDLE: z.string().min(1),
    NEXT_PUBLIC_YOUTUBE_URL: z.string().url(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_ADDRESS_FULL: process.env.NEXT_PUBLIC_ADDRESS_FULL,
    NEXT_PUBLIC_INSTAGRAM_HANDLE: process.env.NEXT_PUBLIC_INSTAGRAM_HANDLE,
    NEXT_PUBLIC_INSTAGRAM_URL: process.env.NEXT_PUBLIC_INSTAGRAM_URL,
    NEXT_PUBLIC_YOUTUBE_HANDLE: process.env.NEXT_PUBLIC_YOUTUBE_HANDLE,
